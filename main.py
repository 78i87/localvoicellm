...
async def send_to_ollama(text, save_to_memory, screenshot_base64=None):
    ...
    data = {
        "model": LLM,
        "messages": messages,
        "options": {"num_predict": 256}#, "temperature": 0.9, "repeat_penalty": 1.2}
    }
...
async def main():
    ...
    while True:
        ...
        if transcribed_text.strip():
            ...
            llm_response, _ = await send_to_ollama(transcribed_text, save_to_memory, screenshot_base64)
